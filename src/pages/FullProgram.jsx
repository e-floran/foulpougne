...
export default function FullProgram(){
    ...
    return(
        <div className="pageContainer">
            ...
            <Link to={"/fullProgram/sunday/"} title="Le programme du dimanche"><li>Dimanche</li></Link>
            </ul>
